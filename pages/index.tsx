...
import { footerLinks, socialCards } from '@/constants'
        ...
        <div className="relative overflow-hidden desktop:overflow-visible flex flex-col desktop:flex-row-reverse">
          <div className="w-[70%] mb-4 desktop:flex-1">
            ...
            <div className="mb-4 tablet:mb-5 flex gap-x-2 tablet:gap-x-3">
              <a target="_blank" href={homepageContent.socialLinks.discord} className="h-[21px] w-[21px] tablet:h-9 tablet:w-9">
              ...
              <a target="_blank" href={homepageContent.socialLinks.reddit} className="h-[21px] w-[21px] tablet:h-9 tablet:w-9">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none" className="tablet:h-9 tablet:w-9">
              ...
              <a target="_blank" href={homepageContent.socialLinks.instagram} className="h-[21px] w-[21px] tablet:h-9 tablet:w-9">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none" className="tablet:h-9 tablet:w-9">
          ...
          <div className="h-1/4 desktop:h-auto flex overflow-hidden desktop:overflow-visible items-baseline translate-y-6 tablet:translate-y-12 desktop:translate-y-0 desktop:flex-1">
            {socialCards.map((card, index) => {
              ...
              return (
                <a target="_blank" href={card.href} key={card.src} className={`${stylesMap[index] || 'scale-100'}`}>
