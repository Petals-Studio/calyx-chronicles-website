...
export default function PrivacyPolicy() {
  const data = `
<p>This User Agreement (&ldquo;Agreement&rdquo;) governs your access and use of products, content, and services offered by Paradox Interactive AB (&ldquo;Paradox&rdquo;), such as games published by Paradox (&ldquo;Games&rdquo;) and thereto related content, mod tools, upgrades, patches, features, launchers, websites, forums, events hosted by Paradox and any other service offered by Paradox (collectively &ldquo;Services&rdquo;).</p>
...
<ol>
	...
	<li>
		<p>The Services are licensed to you for non-commercial use and Paradox reserves all rights to those Services.</p>
	</li>
	<li>
		<p>You may need a Paradox Account to get the full experience of a Service.</p>
	</li>
	<li>
	...
	<li>
		<p>We may require you to install and use the Paradox Launcher to run the Services. Failure to use the Launcher may make the Services unavailable.</p>
	</li>
	<li>
...
<h2>Long Version</h2>
<h3>1. License</h3>
<p>The Services are licensed or otherwise made available to you, not sold. Paradox or its licensors own and reserve all rights to the Services, including all rights, title, and interest in the intellectual property rights.</p>
<p>If and as long as you comply with this Agreement, Paradox grants you a personal, limited, non-transferable, revocable, and non-exclusive license to use the Services, which you have duly obtained access to, for your non-commercial use (unless stated otherwise herein or specifically agreed between you and Paradox).</p>
<h3>2. Paradox Account</h3>
<p>Some Services may require you to have a Paradox Account. A Paradox Account can be created by signing up using a valid email address and providing accurate, truthful, and complete information.</p>
<p>You must be 16 years of age or older to create a Paradox Account (or the minimum age of your country of residence, if higher). If you are between the ages of 16 and the minimum age requirement of your country of residence, a parent or legal guardian must read and accept this Agreement on your behalf. You are not allowed to have multiple Paradox Accounts.</p>
<h3>3. Changes to Services</h3>
<p>Paradox may from time to time, patch, update, change or modify a Service (collectively &ldquo;Changes&rdquo;). Such Changes are for example done to improve and re-balance gameplay as well as improve the stability of the Service, or generally to improve the Services. We will inform you of such Changes within the Services, for example in the patch notes. You may be required to install or otherwise implement such Changes in order to continue to use the Services. The Changes may cause irritation (but likely satisfaction), setbacks (but likely progress), or limitations (but likely extensions or expansions) within the relevant Service and may affect gameplay.</p>
<h3>4. Availability</h3>
<p>Paradox does not guarantee that any Service or part of Service will be available at all times, in all locations, or at any given time or extent or that we will continue to offer a particular Service or part of Service for any particular length of time, or that a Service will continue to receive Changes.</p>
<p>Paradox may act in relation to your use of the Services (for example your Paradox Account) with or without notice to you, in order to protect you, other users, or Paradox, for example by restricting your access to the Services, resetting your Paradox Account password, and delete data.</p>
...
<p>We are not always the owner of the intellectual property for a Game and therefore, we cannot unconditionally allow UGC to all Games. Please contact our support team at&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>&nbsp;if you wonder which Games are affected.</p>
...
<p>Your rights in your UGC only extend to the new, original content you create as part of your UGC and do not extend to or grant any rights to the Services or anything created or made available by third parties, or any content made available by Paradox through the Services.</p>
...
<p>Paradox is under no obligation to use, distribute or continue to distribute UGC and we may restrict or remove your UGC at our sole discretion.</p>
<p>If you encounter content created by another user that you find offensive, we encourage you to report this content by filing a ticket using our support portal. You can access the portal using the following URL:&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>. Please provide as much detailed information in the ticket as possible, including but not limited to: what content you find offensive, the user name of the person exposing you to such content, what type of platform you were using, game version number, save game ID/SGID for the multiplayer session (if applicable) and any other form of relevant information that might help us identify the content and/or user.</p>
<h3>6. Streaming Paradox Games</h3>
<p>You may make videos, live streams, or artwork that contain gameplay, music, sound, and screenshots from our Services (&ldquo;Paradox Game Content&rdquo;) and share them on media sharing websites such as Twitch, YouTube, Bilibili, Reddit, etc. provided that your content is freely available to the public (for example you may not place your content behind a paywall). Monetization of such content is allowed only via such websites&rsquo; official affiliate, advertising, or partner programs. Other forms of monetization of Paradox Game Content are not permitted.</p>
<p>You may only use Paradox Game Content from Games that have been officially released to the public, or from promotional materials officially released (such as product trailers) unless you have been directed in writing by us or our partners to do so.</p>
<p>You must include your own creative input and commentary in Paradox Game Content. It is not permitted to make videos and images that just contain mere copies of Paradox Game Content without any of your creative input.</p>
<p>If you want to use the intellectual property of a third party (for example music) together with Paradox Game Content, you are responsible for obtaining any necessary third-party permissions. Please note that some Game soundtracks or songs included in our Services may not be owned by us. As this varies from Game to Game, be aware that music may trigger content flags and potential removal of the video. In addition, Game soundtracks may never be posted or distributed separately and apart from Game footage. Also, music from the following soundtracks/channels cannot be used:</p>
<ul>
...
<ul>
	...
	<li>take any actions that negatively affect Paradox, your fellow Paradoxians, or anyone else (for example spam the forums, share personal data, harass, troll, necropost, post any NSFW content or any Nazi propaganda or symbols, or disturb the peace); or</li>
	<li>promote, encourage or take part in any prohibited activity described above.</li>
</ul>
<p>For more detailed information, please refer to the Code of Conduct&nbsp;<a href="https://legal.paradoxplaza.com/rules-of-conduct?locale=en">https://legal.paradoxplaza.com/rules-of-conduct?locale=en</a>.</p>
<h3>8. Games and Launcher</h3>
<p>Prior to playing any Game, Paradox may require that you install and use the latest version of the Game launcher (&ldquo;Paradox Launcher&rdquo;). You understand that The Paradox Launcher and/or Game may download and install updates, upgrades, and additional features automatically and you agree that Paradox has no obligation to support previous versions of the Paradox Launcher or Game upon the availability of an update, upgrade, and/or implementation of additional features. Failure to install available updates may render the Game, and/or Services, unavailable/unplayable.</p>
<p>You may install a Game on different computers but you may only run a Game on one computer/device at a time.</p>
<h3>9. Term and Termination</h3>
<p>This Agreement is effective until terminated by you or Paradox. Paradox may terminate this Agreement if Paradox determines that you have failed to comply with the terms and conditions of the Agreement. Paradox will, if practical, notify you of its decision to terminate. You shall then immediately cease all use of the Service(s). The termination may result in you losing your Paradox Account name, username, achievements, forum badges, and other content associated with your Paradox Account or use of the Service.</p>
<p>Prior to terminating the Agreement, Paradox may issue you a warning, suspend, or alter your access to a Service, remove or delete any content which violates this Agreement, or ban your account or device from accessing certain Services. You will not be entitled to any refund if such action is taken and nothing will be credited.</p>
...
<p>Paradox guarantees that the Services will provide the features and functions generally described in the latest relevant product documentation at the time of your purchase or use of the Service.</p>
<p>Paradox does not guarantee that the service or your ability to use it will be uninterrupted or error-free. To the extent permitted by applicable law, we disclaim any implied warranty of merchantability or fitness for a particular purpose.</p>
<p>To the maximum extent permitted by applicable law, in no event shall Paradox, its affiliates, or licensees, be liable for any special, incidental, indirect, or consequential damages whatsoever (including, without limitation, damages for loss of business profits, business interruption, loss of business information, or any other pecuniary loss) arising out of the use of or inability to use the Service or defect in or caused by the Service, including but not limited to compromising the security of your unit on which the Services run, operating system or files, or the provision of or failure to provide support services, even if Paradox has been advised of the possibility of such damages. You may recover only direct damages in an amount no greater than what you actually paid for the applicable Service if any.</p>
<h3>12. Governing Law and Dispute Resolution</h3>
<p>You agree that this Agreement shall be deemed to have been made and executed in Sweden and any dispute arising under this Agreement shall be resolved in accordance with the laws of Sweden, excluding the law of conflicts and the Convention on Contracts for the International Sale of Goods.</p>
<p>Most disputes, claims, or controversies regarding this Agreement (&ldquo;Disputes&rdquo;) can be resolved by contacting Paradox at&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>. Therefore, you agree to first attempt to solve any Dispute informally with Paradox for 30 days before initiating any court proceeding. Should the Dispute not be resolved by informal negotiations, you agree, to the extent permitted by applicable law, that the Dispute shall be determined exclusively by binding arbitration. The arbitration shall be administered by the Arbitration Rules of the Arbitration Institute of the Stockholm Chamber of Commerce. The arbitral tribunal shall be composed of one arbitrator with the seat of arbitration in Stockholm, and the arbitral proceedings shall be conducted in the English language.</p>
<p>If arbitration is unenforceable, you agree that the Dispute shall be determined exclusively by the courts located in Stockholm, Sweden. Irrespective of the dispute resolution, you hereby waive any right to trial by jury and the right to participate in any type of class action.</p>
<h3>13. Updates to this Agreement</h3>
