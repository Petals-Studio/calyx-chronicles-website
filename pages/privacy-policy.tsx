...
export default function PrivacyPolicy() {
  ...
  <p>For more information about the rights you have in relation to your personal information, please see sections 14- 20 below. If you have any concerns as to how we use your personal information, we would kindly ask you to contact us first. However, you can always lodge a complaint with a relevant authority, specifically where you live, work or where you believe an infringement of you rights has occurred. The relevant data protection authority in Sweden is Integritetsskyddsmyndigheten,&nbsp;<a href="https://www.imy.se/">https://www.imy.se</a>. Please see section 22 for further information.</p>
  <p>If you have any questions about the personal information we collect, how we use your data and how we transfer your data to fulfil our purposes as stated herein, please contact us at:&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>&nbsp;or by mail; PARADOX INTERACTIVE AB, Att. Privacy team Magnus Ladul&aring;sgatan 4, 118 66 Stockholm, Sweden. Below follows a more detailed description of how we use personal information.</p>
  <h2>CONTENT</h2>
  <ol>
    <li>Who we are</li>
  ...
  <h2>1. WHO WE ARE</h2>
  <p>We are Paradox Interactive. This Policy applies to websites operated by us and by Triumph Studios, White Wolf Entertainment, Harebrained Schemes, and any other of our affiliates, including on&nbsp;<a href="https://paradoxplaza.com/">https://paradoxplaza.com</a>,&nbsp;<a href="https://paradoxinteractive.com/">https://paradoxinteractive.com</a>,&nbsp;<a href="https://forum.paradoxplaza.com/">https://forum.paradoxplaza.com</a>,&nbsp;<a href="http://harebrained-schemes.com/">http://harebrained-schemes.com</a>, and on&nbsp;<a href="http://triumph.net/">http://triumph.net</a>. This Policy also applies to your use of our services such as the Paradox Store, forums and Paradox Account and also when you use and play our games or other products (we call all of the above &ldquo;Services&rdquo;). We are the controller of the personal information collected. If you have any questions or want to know more about how we use your personal information, please contact us by logging in to your Paradox Account or by directly contacting our Support Department at:&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>, or contact us as stated in the beginning of this Policy. Our physical address can be found at the end of this Policy under the section HOW TO CONTACT US AND HOW TO COMPLAIN.</p>
  ...
  <ul>
    <li>to fulfil a contract we have with you (for example, when you have purchased a game on our Paradox Store);</li>
    ...
    <li>when you consent to it (for example, when subscribing to our newsletter or opening a Paradox Account); or</li>
  ...
  <ul>
    ...
    <li>When you work for Paradox. In such case, please contact our Human Resources department separately for more information.</li>
  </ul>
  ...
  <p>The above information may be provided to us when you open a Paradox Account, or when you subscribe to our press releases or newsletters. In addition to the above, and when purchasing a game or enrolling in an event, you may have to provide us with the following data:</p>
  <ul>
  ...
  <ul>
    ...
    <li>you apply for a job at Paradox and provide information relevant to the application. For more information on how we use personal information in that respect, please refer to the privacy policy available on our job applications website.</li>
  </ul>
  ...
  <p>Data from third parties we work with: We may receive data about you from third parties or partners, like for example Facebook. A full list of such third parties is available on our website under&nbsp;<a href="https://legal.paradoxplaza.com/third-party?locale=en">https://legal.paradoxplaza.com/third-party?locale=en</a>.<br />When you link your Paradox Account with a game platform or other account, we may collect Personal Information about you from such account, including your game library.</p>
  ...
  <p>A full list of these partners or Third Parties can be found here:&nbsp;<a href="https://legal.paradoxplaza.com/third-party?locale=en">https://legal.paradoxplaza.com/third-party?locale=en</a>. Please note that our games or products may be advertised in other applications. If you click on one of these advertisements and install our game, you will become a user of our Services. To prevent fraud and verify the installation of the game, we may share your IDFA (iOS) and/or Advertiser ID (Android) with the relevant advertiser. For Services using the Unity Engine, such as for example our game Cities: Skylines, Unity is our service provider. For Services using the Unreal Engine, Unreal is our service provider. Both Unity and Unreal may collect certain data in relation to your use of such Services. You can find their privacy policy on their websites under&nbsp;<a href="https://unity3d.com/legal/privacy-policy">https://unity3d.com/legal/privacy-policy</a>&nbsp;and&nbsp;<a href="https://www.epicgames.com/site/en-US/privacypolicy">https://www.epicgames.com/site/en-US/privacypolicy</a>. We may release your data when we are required to by a court order, according to law or in the event of a bankruptcy or other similar unfortunate event. We may also share and may acquire your data with future subsidiaries or companies if we choose to sell, transfer or merge parts of our business. We will, however, only transfer the data if we must and if these companies comply with applicable privacy regulations and can guarantee that your data will be kept safe.</p>
  <h2>9. CAN CHILDREN USE OUR SERVICES?</h2>
  <p>Our Services and games are not directed to children and we do not knowingly collect information from children under 13 years of age. From May 25, 2018, only children over 16 years old are allowed to open a Paradox Account. We strongly recommend parents or guardians to instruct their children to not disclose any data when online. Parents or guardians who are concerned about the transfer of data are welcome to contact us at&nbsp;<a href="http://www.paradoxplaza.com/support">www.paradoxplaza.com/support</a>. If we obtain actual knowledge that we have collected data from a child, we will promptly delete it, unless we are legally obligated to retain such data.</p>
  ...
  <p>You can access a copy of your data by logging into your Paradox Account at&nbsp;<a href="https://accounts.paradoxplaza.com/login">https://accounts.paradoxplaza.com/login</a>&nbsp;and then contact our Support department at any time at&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>. If you request access to personal information about you that you yourself have provided and (i) if the personal information is being processed automatically and (ii) in accordance with a contract between you and Paradox Interactive or based on your consent, you may request that the data is provided in a structured, commonly used and machine-readable format and you may also request that the personal information is transmitted to another controller, if this is technically feasible.</p>
  <h2>19. HOW TO ENFORCE YOUR RIGHTS</h2>
  <p>You can contact our Support department at&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>&nbsp;any time to get a list of all the data we have collected from you or to get such data deleted or invoke your other rights as explained above. We will do our bests to answer your request in a timely manner but please note that it may take a couple of days. Thank you for your patience and understanding. Please note that if we cannot identify and guarantee who you are, we might ask you to provide us with additional information or log into your Paradox Account if possible. Please note that we will not delete any data if we are unable to verify that you are their rightful owner. We will however always use our best effort to help you out.</p>
  <h2>20. HOW TO WITHDRAW YOUR CONSENT OR DELETE YOUR ACCOUNT</h2>
  <p>You can withdraw your consent to cookies on our website at any time on the following page:&nbsp;<a href="https://www.paradoxplaza.com/manage-cookies-page.html">https://www.paradoxplaza.com/manage-cookies-page.html</a>. Please note that such withdrawal may mean that you will no longer have access to all the functions offered by our website as explained in the HOW DO WE USE COOKIES AND TRACKING TECHNOLOGIES? section of this Policy. You can log into your Paradox Account at any time if you want to delete it. You can do so by logging in on your paradox account at&nbsp;<a href="https://accounts.paradoxplaza.com/">https://accounts.paradoxplaza.com</a>. After logging in, please contact our Support department at&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>&nbsp;and open a ticket by selecting GDPR - Account Deletion Form. However, if you delete your account we will no longer be able to provide you with certain products or Services if you do so and your game experience will be impacted. You will also lose all of your achievements by closing down your Paradox Account and also lose any in-game currencies, virtual items, forum icons, access to games in the Paradox Launcher, any game progress data stored on your Paradox account and any other contents stored on your Paradox Account</p>
  <p>You can unsubscribe to newsletters at any times by following the instructions in the newsletter you receive. Our newsletters contain mechanisms which allow you to opt-out from receiving further newsletters from us. You can also unsubscribe to newsletters directly on the settings page of your Paradox Account:&nbsp;<a href="https://accounts.paradoxplaza.com/settings">https://accounts.paradoxplaza.com/settings</a>&nbsp;It is also possible for you to opt-out from third parties tracking systems, for example via Adjust Opt-Out Tracking on&nbsp;<a href="http://www.adjust.com/opt-out">www.adjust.com/opt-out</a>.</p>
  <h2>21. CHANGES IN THE PRIVACY POLICY</h2>
  <p>This Policy may change from time to time. Any changes to this Policy will be posted on this page and on our website&nbsp;<a href="https://legal.paradoxplaza.com/">https://legal.paradoxplaza.com</a>, and if the changes are significant, we will provide you with a more noticeable notice, like for example by email or with a pop-up in our games or on your Paradox Account page. If you are asked to accept material changes to this Policy and decline to do so, you might not be able to continue using the Services with all functionality preserved.</p>
  <h2>22. HOW TO CONTACT US AND HOW TO COMPLAIN</h2>
  <p>Please let us know if you are not happy with the way we use and process your data by contacting our Support department at:&nbsp;<a href="https://support.paradoxplaza.com/hc/en-us">https://support.paradoxplaza.com/hc/en-us</a>&nbsp;We will also appreciate to get feedback from you if you think that this Policy or any part of it is unclear. Our address is: PARADOX INTERACTIVE AB, Att. Privacy team Magnus Ladul&aring;sgatan 4, 118 66 Stockholm, Sweden.</p>
  <p>You always have the right to lodge a complaint with the relevant authority in particular where you live, work or where an alleged infringement of the GDPR has occurred. For example, the relevant authorities in Sweden is Integritetsskyddsmyndigheten&nbsp;<a href="https://www.imy.se/">https://www.imy.se</a>.</p>
  <h2>23. OTHER USEFUL INFORMATION</h2>
  <p>Further useful privacy and legal information can be found on the Legal Information pages of our website:&nbsp;<a href="https://legal.paradoxplaza.com/">https://legal.paradoxplaza.com</a>&nbsp;and&nbsp;<a href="https://www.paradoxplaza.com/legal-static-info-ca.html">https://www.paradoxplaza.com/legal-static-info-ca.html</a>&nbsp;Information about privacy rights for EU residents can be found on:&nbsp;<a href="https://ec.europa.eu/info/law/law-topic/data-protection">https://ec.europa.eu/info/law/law-topic/data-protection</a>.</p>
  `;
